    ...
    return(
        <div className="header">
            <div className="logo-container">
                <img 
                className="logo"
                src="/assets/NaanStopLogo.png" alt="NaanStop Logo"/>
            </div>
    ...
    return (
      <div className="red-card" style={{ backgroundColor: "#f0f0f0" }}>
        <img
          ...
          alt="res-logo"
          src={
            "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_850,h_504/rng/md/carousel/production/3ebfdc6e45760408e89de921eeb1c5cd" +
